...
const B3FloorPlan = () => {
  ...
  const getBackgroundImage = () => {
    ...
    if (floorNumber === 15) {
      return `${process.env.PUBLIC_URL}/assets/b3FloorPlans/15-Penthouse-Floor.png`;
    }
  ...
  const renderApartment = (apartment, entranceName) => {
    ...
    return (
      <div
        key={apartmentKey}
        className={`apartment-item b3_apartment-item b3_apartment-item${entranceName + apartment.apartment} ${
          isActive ? "active" : ""
        }`}
